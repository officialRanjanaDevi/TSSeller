const DashboardStatsGrid = ({ data, sellerData }) => {
  console.log(sellerData, "d");
      ...
      <div className="flex flex-col lg:flex-row gap-4 justify-around mx-4 mt-4">
        <div className="shadow-lg w-9/10 gap-y-2 lg:w-64  bg-white rounded-md flex gap-4 justify-between p-4 items-center">
          <div>
            ...
            <strong>{sellerData.length}</strong>
          </div>
          <svg
            width="46"
            height="46"
        ...
        <div className="shadow-lg w-9/10 lg:w-64 bg-white rounded-md flex gap-4 justify-between p-4 items-center">
          <div>
            <h2 className="font-bold">Total Visitors Visited</h2>
            <p className="flex items-center gap-1">
              <svg
                width="20"
                height="21"
              ...
              <strong>{data?.totalVisitors===null ? data?.totalVisitors : 0}</strong>
            </p>
        ...
        <div className="shadow-lg w-9/10 lg:w-64 bg-white rounded-md flex gap-4 justify-between p-4 items-center">
          <div>
            <h2 className="font-bold">Unique Visitors Visited</h2>
            <p className="flex items-center gap-1">
              <svg
                width="20"
                height="21"
              ...
              <strong>{data?.UniqueVisitors===null ? data?.UniqueVisitors : 0}</strong>
            </p>
